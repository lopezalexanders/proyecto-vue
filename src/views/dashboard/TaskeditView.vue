...
import type {  UpdateTask } from '@/interfaces/task.interface'
...
const taskregister = reactive<UpdateTask>({
  name: '',
})
...
async function Submit() {
  ...
  try {
    console.log('Actualizando tarea', taskregister)
    await run(() => AutheService.update({
      taskid: taskId,
